...
public class AlchemyGuardianDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 11:
			...
			break;
		case 12:
			npc("around "+GameWorld.getName()+". Keep an eye on the cost of each", "items as these will change from time-to-time, as will the", "location of the items. Occasionally one of the items will", "be indicated as costing no runestones to convert to");
			stage++;
			break;
		case 13:
			npc("money.");
