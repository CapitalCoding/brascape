...
public class GraveyardGuardianDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 1:
			...
			break;
		case 10:
			npc("Have you noticed all the bones around the room? These", "are teleported here from all over "+GameWorld.getName()+" to help", "clean up the landscape of countless bones left behind", "from combat. What better use for these bones than to");
			stage++;
			break;
		case 11:
