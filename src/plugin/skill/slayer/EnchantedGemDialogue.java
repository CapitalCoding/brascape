...
import org.wildscape.game.content.skill.member.slayer.Master;
...
public final class EnchantedGemDialogue extends DialoguePlugin {
	...
	public String masterLocation() {
		if (player.getSlayer().getMaster().getNpc() == org.wildscape.game.content.skill.member.slayer.Master.MAZCHNA.getNpc())
			return "Canifis";
		else if (player.getSlayer().getMaster().getNpc() == org.wildscape.game.content.skill.member.slayer.Master.TURAEL.getNpc())
			return "Taverley";
		else if (player.getSlayer().getMaster().getNpc() == org.wildscape.game.content.skill.member.slayer.Master.CHAELDAR.getNpc())
			return "Zanaris";
		else if (player.getSlayer().getMaster().getNpc() == org.wildscape.game.content.skill.member.slayer.Master.VANNAKA.getNpc())
			return "Edgeville dungeon";
		else if (player.getSlayer().getMaster().getNpc() == org.wildscape.game.content.skill.member.slayer.Master.DURADEL.getNpc())
