...
import org.wildscape.game.content.holiday.HolidayType;
...
public class ChristmasEvent extends HolidayEvent {
	...
	public static class SnowImpDialogue extends DialoguePlugin {
		...
		private static final String[][] SAYINGS = new String[][] {
			...
			{"I'm dreaming of a white "+GameWorld.getName()+""},
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 42:
				...
				break;
			case 100:
				options("Who are you?", "Could I have a snowman hat, please?", "Could I have a snowman weapon, please?", "I want to go back to "+GameWorld.getName()+".");
				stage++;
				break;
			case 101:
				switch (buttonId) {
				...
				case 3:
					...
					break;
				case 4:
					player("I want to go back to "+GameWorld.getName()+".");
					stage = 140;
					break;
				}
				break;
			...
			case 131:
				break;
			case 140:
				npc("Very well. You may return here during Christmas-time, when", "the Land of Snow is close to "+GameWorld.getName()+".");
				stage++;
				break;
			case 141:
	...
	public class QueenOfSnowDialogue extends DialoguePlugin {
		...
		public boolean handle(int interfaceId, int buttonId) {
			switch (stage) {
			case 15:
				options("Ooh, a present?", "I want to go back to "+GameWorld.getName()+".");
				stage++;
				break;
			case 16:
				switch (buttonId) {
			...
			case 100:
				...
				options("Happy Christmas, Your Majesty.", "Why have you sent snow to "+GameWorld.getName()+"?", "What is the Land of Snow?", "What is the snow globe for?", "I want to go back to "+GameWorld.getName()+".");
				stage++;
				break;
			case 101:
				switch (buttonId) {
				case 1:
					...
					break;
				case 2:
					player("Why have you sent snow to "+GameWorld.getName()+"?");
					stage = 120;
					break;
				case 3:
			...
			case 140:
				...
				break;
			case 150:
				npc("Very well. You may return here during Christmas-time,", "when the Land of Snow is close to "+GameWorld.getName()+". Just speak to", "a snowman or snow imp.");
				stage++;
				break;
			case 151:
				sendChristmasTeleport(player, player.getAttribute("last-location", HUBS[0]));
