...
public class PriestInPerilUsePlugin extends UseWithHandler {
	...
	/**
	 * (non-Javadoc)
	 * @see org.wildscape.plugin.Plugin#newInstance(java.lang.Object)
	 */
	@Override
	...
	/**
	 * (non-Javadoc)
	 * @see org.wildscape.game.interaction.UseWithHandler#handle(org.wildscape.game.interaction.NodeUsageEvent)
	 */
	@Override
