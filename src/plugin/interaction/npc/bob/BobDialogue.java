...
import org.wildscape.game.content.global.RepairItem;
...
public final class BobDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 31:
			...
			break;
		case 110:
			npc("Ah, well it's a diary that helps you keep track of", "particular achievements you've made in the world of", GameWorld.getName()+". In Lumbridge and Draynor i can help you", "discover some very useful things indeed.");
			stage++;
			break;
		case 111:
