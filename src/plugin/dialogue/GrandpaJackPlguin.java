...
public final class GrandpaJackPlguin extends DialoguePlugin {
	...
	public boolean open(Object... args) {
		...
		if (!donatorZone) {
			...
			npc("Welcome, " + player.getUsername() + ". Before you is the wonderful land", "of the donators. Here at your disposal is access to", "an overubandance of resources. Your support for", GameWorld.getName()+" has not gone unrecognized.");
			stage = 3;
		}
		return true;
	}
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 5:
			...
			case 1:
				...
				break;
			case 2:
				npc("Beyond that waterfall lays a land of extreme benefits", "accessible to only the most supportive players of "+GameWorld.getName()+".", "The area contains skilling resources including trees,", "rocks, fish and banks to sooth for easy skilling.");
				stage = 8;
				break;
			case 3:
		...
		case 9:
			if (player.getDonatorType() == DonatorType.EXTREME) {
				npc("Yes child! You are an extreme donator and have shown", "great compassion for "+GameWorld.getName()+". To show our gratitude", "we offer you the land of extreme donators.");
			} else {
