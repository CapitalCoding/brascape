...
public class SaniDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 21:
			...
			break;
		case 22:
			player("I see...", "So this means that you only sell common armours", "to help adventurers like nyself get started in the world", "of "+GameWorld.getName()+".");
			stage++;
			break;
		case 23:
			npc("Indeed, that is true. If you have any more questions", "The "+GameWorld.getName()+" guide near the green portal should be able", "to assist you further.");
			stage = 0;
			break;
		case 30:
