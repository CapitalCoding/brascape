...
import org.wildscape.game.content.global.shop.ShopViewer;
...
public final class GrandExchangeZone extends MapZone implements Plugin<Object> {
	...
	public final class RewardTraderDialogue extends DialoguePlugin {
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 2:
				...
				break;
			case 3:
				interpreter.sendDialogues(8631, FacialExpression.OSRS_NORMAL, "Visit our website by heading to "+ServerConstants.WEBSITE_ADDRESS+".", "Log-in to the website with your in-game details", "and then simply vote via the account panel in order", "to obtain your credits.");
				stage = 4;
				break;
			case 4:
	...
	private final void addObjects(){
		...
		//ObjectBuilder.add(new GameObject(29534, new Location(3159, 3484), 1));
