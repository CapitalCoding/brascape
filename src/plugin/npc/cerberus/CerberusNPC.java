...
import org.wildscape.game.content.global.BossKillCounter;
...
import org.wildscape.game.node.entity.combat.equipment.SwitchAttack;
import org.wildscape.game.node.entity.combat.handlers.MultiSwingHandler;
...
public class CerberusNPC extends IdleAbstractNPC {
	 ...
	 */
	public static final Animation PROJECTILE = new Animation(15676);

	/**
	 * Cerberus's death animation.
	 */
	public static final Animation DEATH = new Animation(15682);

	/**
	 * Cerberus's melee animation.
	 */
	public static final Animation MELEE = new Animation(15678);

	/**
	 * Cerberus's aarrooo animation.
	 */
	public static final Animation HOWL = new Animation(15681);

	/**
	 * Cerberus's grrr attack.
	 */
	public static final Animation GR = new Animation(15680);

	/**
	 * The range soul animation.	
	 */
	public static final Animation RANGE_SOUL = new Animation(15690);

	/**
	 * The mage soul animation.
	 */
	public static final Animation MAGE_SOUL = new Animation(15691);

	/**
	 * Cerberus's grrr graphic.
	 */
	public static final Graphics LAVA = new Graphics(3244);
	...
	public boolean isAttackable(Entity entity, CombatStyle style) {
		if (entity instanceof Player && entity.asPlayer().getSkills().getStaticLevel(Skills.SLAYER) < 91) {
			entity.asPlayer().sendMessage("You need a higher slayer level to know how to wound this monster.");
			return false;
		}
