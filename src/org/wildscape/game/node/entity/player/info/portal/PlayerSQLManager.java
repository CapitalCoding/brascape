package org.wildscape.game.node.entity.player.info.portal;
...
import org.wildscape.game.system.mysql.SQLColumn;
import org.wildscape.game.system.mysql.SQLEntryHandler;
import org.wildscape.game.system.mysql.SQLManager;
import org.wildscape.game.system.mysql.SQLTable;
import org.wildscape.game.system.mysql.impl.PlayerSQLHandler;
...
public final class PlayerSQLManager {
	...
	public static Response getCredentialResponse(String name, String pass) throws SQLException {
		...
		if (result == null || !result.next()) {
			SQLManager.close(connection);
			return Response.ERROR_LOADING_PROFILE;
		}
