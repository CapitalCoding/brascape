package org.wildscape.game.node.entity.state;

import org.wildscape.game.node.entity.state.impl.AvaDevicePulse;
import org.wildscape.game.node.entity.state.impl.ChargedStatePulse;
import org.wildscape.game.node.entity.state.impl.DiseaseStatePulse;
import org.wildscape.game.node.entity.state.impl.DoubleExperiencePulse;
import org.wildscape.game.node.entity.state.impl.FireResistantPulse;
import org.wildscape.game.node.entity.state.impl.FrozenStatePulse;
import org.wildscape.game.node.entity.state.impl.IncubatorStatePulse;
import org.wildscape.game.node.entity.state.impl.MiasmicStatePulse;
import org.wildscape.game.node.entity.state.impl.PoisonStatePulse;
import org.wildscape.game.node.entity.state.impl.SkullStatePulse;
import org.wildscape.game.node.entity.state.impl.StaffOfTheDeadPulse;
import org.wildscape.game.node.entity.state.impl.StunStatePulse;
import org.wildscape.game.node.entity.state.impl.TeleblockStatePulse;
