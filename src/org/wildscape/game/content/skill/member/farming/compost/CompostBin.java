package org.wildscape.game.content.skill.member.farming.compost;

import java.util.concurrent.TimeUnit;

import org.wildscape.cache.def.impl.ConfigFileDefinition;
...
public final class CompostBin {
	...
	public void close(final Player player) {
		final boolean test = GameWorld.getSettings().isDevMode() && player.getName().equals("cabbage");
