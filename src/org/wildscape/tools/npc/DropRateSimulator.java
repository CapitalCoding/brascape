package org.wildscape.tools.npc;
...
import org.wildscape.game.content.eco.EcoStatus;
import org.wildscape.game.content.eco.EconomyManagement;
import org.wildscape.game.node.entity.npc.NPC;
import org.wildscape.game.node.entity.npc.drop.NPCDropTables;
import org.wildscape.game.node.entity.npc.drop.RareDropTable;
import org.wildscape.game.node.item.ChanceItem;
...
public final class DropRateSimulator {
	...
	public static void main(String[] args) throws Throwable {
		...
		NPC npc = NPC.create(NPC_ID, ServerConstants.HOME_LOCATION);
		npc.init();
		...
		for (int j = 0; j < 1; j++) {
			...
			System.out.println("Starting round - " + j + 
					" using mod rate - " + tables.getModRate());
